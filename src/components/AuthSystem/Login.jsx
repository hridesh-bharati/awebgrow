      ...
      <div className="position-relative overflow-hidden custom-card d-flex flex-column p-3 p-sm-4 p-md-5 my-1">
        ...
        <div className="flex-grow-1">
          <form onSubmit={handleSmartLogin} className="d-flex flex-column gap-2.5">
            ...
            <button type="submit" className="btn w-100 rounded-pill py-2 fw-bold text-white mt-1" style={{ height: '46px', background: 'linear-gradient(135deg, #9333ea 0%, #ec4899 50%, #f97316 100%)', border: 'none', fontSize: '0.9rem' }} disabled={loading}>
          ...
          <div className="text-center mt-3">
            <span style={{ color: '#9ca3af' }} className="small">Don't have an account? </span>
